...
export default class App extends Component {
  ...
  displayResults = (query = 'twenty one pilots') => {
    axios.get(`https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=${flickrKey}&tags=cats&per_page=24&format=json&nojsoncallback=1`)
    .then(res => {
    ...
    return (
      <div className='container'>
        <BrowserRouter>
          ...
          <Nav />
          <Switch>
            <Route exact path='/' render= {() => <Photo name='twenty one pilots' />}/>
